...
void getSensors(State *state){
	...
	switch(SensorValue[color]){
		case BLACKCOLOR: state->blackColor = true; break;
		case REDCOLOR: ; //flow into next case since red and blue tape should be treated identically
		case BLUECOLOR: state->blackColor = false; break;
		default: state->blackColor = true;
	}
